...
ALTER TABLE public.historico_movimentacoes ADD CONSTRAINT fk_tipo_movimentacao FOREIGN KEY (tipo_movimentacao_id) REFERENCES tipomovimentacao(tipo_movimentacao_id);
...
alter table public.movimentacoes add constraint fk_tipo_movimentacao foreign key (tipo_movimentacao_id) references tipoMovimentacao(tipo_movimentacao_id);
